...
class AndroidFlutterLocalNotificationsPlugin
  ...
  Future<int> extractMessageReceivedNum(String payload) async {
    final num = (await _channel
        .invokeMethod<int?>("getMessageReceivedNum", {"payload": payload})) ?? 0;
    await _channel.invokeMethod("setMessageReceivedNum", {"payload": payload, "num": 0});
    return num;
  }
  ...
  Future<bool?> subscribeToTopic(String topic, AndroidNotificationDetails notificationDetails) async {
    return await _channel.invokeMethod('subscribeToTopic', <String, Object?>{
      'id': 0,
      'title': '',
      'body': '',
      'topic': topic,
  ...
  Future<void> showBroadcastNotification(
    ...
    await _channel.invokeMethod("showBroadcastNotification", <String, Object?>{
      'id': id,
      'title': title,
      'body': body,
