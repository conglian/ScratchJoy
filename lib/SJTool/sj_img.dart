...
class SJImg extends StatelessWidget {
  final String name;
  final double? width;
  final double? height;
  final double? size;
  ...
  const SJImg({super.key, required this.name, this.size, this.width, this.height, this.fit = BoxFit.fill});

  @override
  Widget build(BuildContext context) {
    var p = "$name".image();
    return Image.asset(p, fit: fit, width: size ?? width, height: size ?? height);
  }
}

DecorationImage SJDImg(String name, {BoxFit fit = BoxFit.fill}) {
  var p = "$name".image();
...
class SJBouncyImage extends StatefulWidget {
  ...
  @override
  State<SJBouncyImage> createState() => _SJBouncyImageState();
}

class _SJBouncyImageState extends State<SJBouncyImage>
  ...
  @override
  void didUpdateWidget(covariant SJBouncyImage oldWidget) {
...
class SJAnimatedImageMove extends StatefulWidget {
  ...
  @override
  _SJAnimatedImageMoveState createState() => _SJAnimatedImageMoveState();
}

class _SJAnimatedImageMoveState extends State<SJAnimatedImageMove>
    with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant SJAnimatedImageMove oldWidget) {
    super.didUpdateWidget(oldWidget);
        ...
        return Transform.translate(
          ...
          child: Transform.scale(
            ...
            child: SizedBox(
              width: widget.ws,
              height: widget.hs,
              child: SJImg(name: widget.imageUrl),
            ),
          ),
        );
      },
